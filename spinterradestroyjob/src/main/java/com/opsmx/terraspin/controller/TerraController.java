...
public class TerraController {
	...
	public void startTerraform(HttpServletRequest request, @RequestBody String payload)
	...
	public JSONObject terraformPlanStatus(HttpServletRequest request, @PathVariable String applicationName,
	...
	public void terraformApplyStatus(HttpServletRequest request, @PathVariable String applicationName,
			@PathVariable String pipelineName, @PathVariable String pipelineId)
			throws IOException, InterruptedException {
		String baseURL = request.getScheme().toString() + "://" + request.getServerName() + ":"
				+ request.getServerPort();
	...
	public void terraformDeleteStatus(HttpServletRequest request, @PathVariable String applicationName,
			@PathVariable String pipelineName, @PathVariable String pipelineId)
			throws IOException, InterruptedException {
		String baseURL = request.getScheme().toString() + "://" + request.getServerName() + ":"
				+ request.getServerPort();
